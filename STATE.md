...
- **[CHECKPOINT-4] Phase 4 에이전트 큐 소진(P4-T1~T8 전부 DoD 통과) — 운영자 판정 대기.** docs/metrics-final.md에 M1–M9 종합. 핵심 쟁점:
  1. ~~G-2(M6 CER) 미달~~ **해결(2026-08-11)** — STT 청크 8s화로 CER 0.458→0.130(정정, 아래 참조)(PASS). 상세: docs/stt-benchmark.md, STATE.md 완료 태스크 항목
